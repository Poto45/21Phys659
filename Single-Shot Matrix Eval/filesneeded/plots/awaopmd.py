...
path2hdf5 = '/data1/aard/cphillips/cslabcode/verylongrun/slabmovingwarpx/'

pythonpath = '/data1/aard/cphillips/cslabcode'

tstamp = time.strftime('%Y%m$d_%H%M%S')

os.mkdir(pythonpath + '/test' + tstamp)
...
#        plt.title('Ez')
        ...
        shutil.move(path2hdf5 + 'rho'+str(it)+'.png',pythonpath + '/test' + tstamp) 
